...
public class GetTimeSlotBySemesterIdDTO {
	...
	public GetTimeSlotBySemesterIdDTO(int day_of_week, String start_time, String end_time, String course_code,
			int teaches_id) {
		super();
	...
	public GetTimeSlotBySemesterIdDTO(int day_of_week, String start_time, String end_time, String course_code,
			int teaches_id, String teacher_name, String course_name) {
		super();
		this.day_of_week = day_of_week;
		this.start_time = start_time;
		this.end_time = end_time;
